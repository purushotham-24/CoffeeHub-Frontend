...
import com.simats.coffeehub.data.filterCoffees
import com.simats.coffeehub.model.Coffee

@Composable
fun FilterCoffeeList(navController: NavController) {
    ...
    Column(
        ...
        LazyVerticalGrid(
            ...
            items(filterCoffees) { coffee ->
                FilterCoffeeCard(coffee, navController)
            }
        }
    }
}
...
@Composable
fun FilterCoffeeCard(coffee: Coffee, navController: NavController) {
