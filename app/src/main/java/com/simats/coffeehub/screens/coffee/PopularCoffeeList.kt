...
import com.simats.coffeehub.data.cappuccinos
import com.simats.coffeehub.data.coldCoffees
import com.simats.coffeehub.data.lattes
import com.simats.coffeehub.model.Coffee

@Composable
fun PopularCoffeeList(navController: NavController) {

    val popularCoffees = cappuccinos.take(2) + lattes.take(2) + coldCoffees.take(2)
    ...
    Column(
        ...
        Row(
            ...
            Text("Popular Coffee", style = MaterialTheme.typography.headlineSmall)
        }
        ...
        LazyVerticalGrid(
            ...
            items(popularCoffees) { coffee ->
                CoffeeCard(coffee, navController)
            }
        }
    }
}
