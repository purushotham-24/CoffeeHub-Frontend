...
@Composable
fun CappuccinoList(navController: NavController) {
    ...
    Column(
        ...
        Row(
            ...
            Text("Cappuccino", style = MaterialTheme.typography.headlineSmall)
        }
        ...
        LazyVerticalGrid(
            ...
            items(cappuccinos) { coffee ->
                CappuccinoCard(coffee, navController)
            }
        }
    }
}
...
@Composable
fun CappuccinoCard(coffee: Coffee, navController: NavController) {
