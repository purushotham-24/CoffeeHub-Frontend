...
@Composable
fun LatteList(navController: NavController) {
    ...
    Column(
        ...
        Row(
            ...
            Text("Latte", style = MaterialTheme.typography.headlineSmall)
        }
        ...
        LazyVerticalGrid(
            ...
            items(lattes) { coffee ->
                LatteCard(coffee, navController)
            }
        }
    }
}
...
@Composable
fun LatteCard(coffee: Coffee, navController: NavController) {
